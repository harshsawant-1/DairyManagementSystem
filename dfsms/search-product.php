...
<head>
    ...
    <title> DFSMS Search Product</title>
...
<li class="breadcrumb-item"><a href="search-product.php">Search</a></li>
<li class="breadcrumb-item active" aria-current="page"><a href="search-product.php"><a href="#">Product</a></li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
        ...
        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>DFSMS Search Product</h4>
                </div>
                <!-- /Title -->
...
<input type="text" class="form-control" id="validationCustom03" placeholder="Enter Product Name" name="productname" required>
<div class="invalid-feedback">Please provide a valid product name.</div>
</div>
</div>

                                 
<button class="btn btn-primary" type="submit" name="search">Search Product</button>
</form>
</div>
</div>
</section>
    ...
    foreach ($_SESSION["cart_item"] as $item){
        ...
        ?>
           <input type="hidden" value="<?php echo $item['quantity']; ?>" name="quantity[<?php echo $item['code']; ?>]">
                ...
                <td><a href="search-product.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="dist/img/android-trash-remove.png" alt="Remove Item" /></a></td>
                </tr>
                <?php
