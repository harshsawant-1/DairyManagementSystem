...
<head>
    ...
    <title> DFSMS View Invoices</title>
    <!-- Data Table CSS -->
...
<div class="hk-pg-header">
 <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="file"></i></span></span>DFSMS View Invoices</h4>
                </div>
                <!-- /Title -->
...
<h4 class="mb-5">Dairy Farm Shop Management System</h4>
...
<h4 class="mb-35 font-weight-600">Invoices / Receipt</h4>
<span class="d-block">Date:<span class="pl-10 text-dark"><?php echo $row['InvoiceGenDate'];?></span></span>
<span class="d-block">Invoices / Receipt #<span class="pl-10 text-dark"><?php echo $row['InvoiceNumber'];?></span></span>
