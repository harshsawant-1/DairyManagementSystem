...
<head>
    ...
    <title>DFSMS Sales B/w Dates Report Details</title>
    <!-- Data Table CSS -->
...
<li class="breadcrumb-item"><a href="bwdate-report-ds.php">Reports</a></li>
<li class="breadcrumb-item active" aria-current="page"><a href="#">B/w Dates Report Details</a></li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
...
?>
    ...
    <span class="feather-icon"><i data-feather="database"></i></span></span>DFSMS B/w Dates report from <?php echo $fdate?> to <?php echo $tdate?></h4>
                </div>
                <!-- /Title -->
