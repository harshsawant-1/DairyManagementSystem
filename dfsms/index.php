...
<head>
    ...
    <title>DFSMS Admin Login Page</title>
...
<span class="text-white font-30">Dairy Farm Shop Management System</span>
     ...
     <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form method="post">
                                    <h2 class="display-4 mb-10">WelcomeBack,Administrator</h2>
                                 
<div class="form-group">
<input class="form-control" placeholder="Enter your Username" type="text" name="username" required="true">
</div>

<div class="form-group">
<div class="input-group">
<input class="form-control" id="password" placeholder="Enter your Password" type="password" name="password" required="true"><span class="toggle-password" onclick="togglePassword()"><i id="toggleIcon" class="fas fa-eye-slash"></i>
</span>
