...
<head>
    ...
    <title>DFSMS Edit Product</title>
...
<li class="breadcrumb-item active" aria-current="page"><a href="#">Edit</a></li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>DFSMS Edit Product</h4>
                </div>
                <!-- /Title -->
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $result['ProductName'];?>" name="productname" placeholder="Enter your Product Name" required>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $result['ProductPrice'];?>" name="productprice" placeholder="Enter your Product Price" required>
<div class="invalid-feedback">Please provide a valid product price.</div>
</div>
</div>
<?php } ?>
<button class="btn btn-primary" type="submit" name="update">Update Product</button>
</form>
</div>
</div>
</section>
