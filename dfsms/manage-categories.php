...
<head>
    ...
    <title>DFSMS Manage Categories</title>
    <!-- Data Table CSS -->
...
<li class="breadcrumb-item"><a href="manage-categories.php">Category</a></li>
...
<div class="hk-pg-header">
 <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>DFSMS Manage Categories</h4>
                </div>
                <!-- /Title -->
