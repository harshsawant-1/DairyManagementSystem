...
<head>
    ...
    <title> DFSMS Admin profile</title>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['AdminName'];?>" name="adminname" placeholder="Enter your Name" required readonly>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['UserName'];?>" name="username" placeholder="Enter your Username" readonly>
</div>
</div>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['Email'];?>" name="emailid" placeholder="Enter your Email ID" required readonly>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['MobileNumber'];?>" name="mobilenumber" placeholder="Enter your Mobile Number" required readonly>
