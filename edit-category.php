...
<head>
    ...
    <title>DFSMS Edit Category</title>
...
<li class="breadcrumb-item active" aria-current="page"><a href="#">Edit</a></li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>DFSMS Edit Category</h4>
                </div>
                <!-- /Title -->
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['CategoryName'];?>" name="category" placeholder="Enter Your Category Name" required>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['CategoryCode'];?>" name="categorycode" placeholder="Enter Your Category Name" required>
