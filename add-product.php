...
<li class="breadcrumb-item"><a href="add-product.php">Product</a></li>
...
<input type="text" class="form-control" id="validationCustom03" placeholder="Enter your Product Name" name="productname" required>
...
<input type="text" class="form-control" id="validationCustom03" placeholder="Enter your Product Price" name="productprice" required>
<div class="invalid-feedback">Please provide a valid product price.</div>
</div>
</div>

<button class="btn btn-primary" type="submit" name="submit">Submit Product</button>
</form>
</div>
</div>
</section>
