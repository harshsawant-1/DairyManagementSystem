...
<head>
    ...
    <title>Date Sales Report Details</title>
    <!-- Data Table CSS -->
...
<li class="breadcrumb-item"><a href="sales-report-ds.php">Reports</a></li>
<li class="breadcrumb-item active" aria-current="page"><a href="#">Sales Report Details</a></li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
...
?>
    ...
    <span class="feather-icon"><i data-feather="database"></i></span></span>DFSMS Sales report from <?php echo $fdate?> to <?php echo $tdate?></h4>
                </div>
                <!-- /Title -->
