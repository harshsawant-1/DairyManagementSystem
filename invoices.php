...
<head>
    ...
    <title>DFSMS Manage Invoices</title>
    <!-- Data Table CSS -->
...
<div class="hk-pg-header">
 <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>DFSMS Manage Invoices</h4>
                </div>
                <!-- /Title -->
