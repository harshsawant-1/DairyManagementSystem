...
<head>
    ...
    <title>DFSMS Change Password</title>
...
<input type="password" class="form-control" id="confirmpassword" placeholder="Enter your Confirm Password" name="confirmpassword" required>
