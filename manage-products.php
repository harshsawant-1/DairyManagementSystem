...
<head>
    ...
    <title>DFSMS Manage Products</title>
    <!-- Data Table CSS -->
...
<li class="breadcrumb-item"><a href="manage-products.php">Product</a></li>
...
<div class="hk-pg-header">
 <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>DFSMS Manage Products</h4>
                </div>
                <!-- /Title -->
